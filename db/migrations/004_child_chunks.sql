...
CREATE TABLE child_chunks (
    ...
    embedding         VECTOR(768),          -- dimension must match EMBEDDING_DIMS in config; Gemini text-embedding-004 = 768
    embedding_model    TEXT NOT NULL,        -- e.g. 'gemini:models/text-embedding-004' -- recorded so you can tell which rows came from which model if you ever swap providers
